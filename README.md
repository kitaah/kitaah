...
- 🔭 Actuellement je travaille sur **un projet d'application en PHP sous Laravel**

- 🌱 Je me forme actuellement sur **Laravel**
...
- **Gestion de base données**: DataGrip, DBeaver, phpMyAdmin, SQL Server Management Studio
- **Manipulation d'API**: Postman, Swagger
- **Outils collaboratifs**: Git, GitLab
